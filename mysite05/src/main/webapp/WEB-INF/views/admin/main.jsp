			...
			<div id="content">
				<div id="site-form">
					<form method="post" action="${pageContext.request.contextPath }/admin/main/update" enctype="multipart/form-data">
						<label class="block-label" for="title">사이트 타이틀1</label>
						<input id="title" name="title" type="text" value="${siteVo.title1 }">
						
						<label class="block-label" for="title">사이트 타이틀2</label>
						<input id="title" name="title" type="text" value="${siteVo.title2 }">
